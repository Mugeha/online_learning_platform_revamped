          ...
          <>
            <section className="card" style={{ marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 12 }}>
                ...
                <Link to="/courses" className="btn ghost" style={{ marginLeft: 10 }}>
                  Browse Courses
                </Link>
              </div>
            </section>
            ...
            <section className="card">
              <h2>Tips</h2>
              <p className="muted">
                Track progress on enrolled courses from <strong>My Courses</strong>. Update your details in <strong>Profile</strong>.
              </p>
            </section>
          </>
        )}
